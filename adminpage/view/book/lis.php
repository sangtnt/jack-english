        ...
        <div class='content-wrapper'>
            ...
            ";
                                    if ($_GET["page"]>$pagelimit){
                                        ...
                                        echo "<label class='pagi'><a  href='index.php?controller=book&action=lis&bookid={$_GET['bookid']}&page={$page}'><i class='mdi mdi-chevron-left'></i><i class='mdi mdi-chevron-left'></i></a></label>";
                                    }
                                    ...
                                    for ($i=$z;$i<=$z+4;$i++){
                                        ...
                                        if ($i==$_GET["page"]){
                                            echo "<label class='pagi pagi-active'><a href='index.php?controller=book&action=lis&bookid={$_GET['bookid']}&page={$i}'>$i</a></label>";
                                        }
                                        else{
                                            echo "<label class='pagi'><a href='index.php?controller=book&action=lis&bookid={$_GET['bookid']}&page={$i}'>$i</a></label>";
                                        }
                                    } 
                                    if (ceil($_GET["page"]/$pagelimit)<$bigpage){
                                        $page=$pagelimit*ceil($_GET["page"]/$pagelimit)+1;
                                        echo "<label class='pagi'><a href='index.php?controller=book&action=lis&bookid={$_GET['bookid']}&page={$page}'><i class='mdi mdi-chevron-right'></i><i class='mdi mdi-chevron-right'></i></a></label>";
                                    }
                            echo"        
                            </td>
                            </tbody>
                    ...
                    <form action='controller/changelis.php' method='post' enctype='multipart/form-data'>
